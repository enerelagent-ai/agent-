...
(Claude Code-той ажиллах явцад энэ хэсгийг тогтмол шинэчилж, "юу дуусгасан / юу хийж байгаа" гэдгээ тэмдэглэ)
 ...
 Week 5: Calculations. Pre-scrape бэлтгэл ✅ (branch: week5-prep): (1) specs JSONB + price_raw + posted_raw хадгалагддаг болсон (migration 006) — 38k scrape-ийн дараа дахин scrape хийлгүйгээр задлалт хийх боломжтой; (2) хуучин зарын огнооны формат баталгаажсан — deep page (100, 300-р хуудас) дээр 'YYYY-MM-DD HH:MM' absolute формат, одоогийн parser зөв уншдаг (live шалгасан); (3) main.py --skip-recent-days N — тасалдсан урт scrape дахин эхлэхэд сүүлийн N хоногт scrape хийсэн зарыг алгасдаг (resume). Бүх 3 live баталгаажсан, test 21/21. Бүрэн scrape-ийн 1-р оролдлого (2026-07-22 шөнө): 5,899 зар хадгалагдаад NumericValueOutOfRange-ээр унасан (бодит зарын үнэ ≥10^12 MNT байдаг) → засвар: migration 007 (price NUMERIC(18,2) болгож өргөсгөсөн, price_per_sqm drop/re-create шаардсан) + upsert-д мөр-мөрөөр fallback (нэг муу зар batch-аа алуулахгүй, skip+log). АНХААР — scorer том хэмжээнд over-match хийж байна: 5,899 зар дээр 4,524 match, 89% нь "Орон сууц зарна" (generic гарчигтай, ойролцоо үнэтэй адил-дүүргийн байрууд 0.60-г давдаг; 2,776 нь 0.60-0.70 зайнд). Бүх шаардлагатай өгөгдөл хадгалагддаг тул scorer-ийг зассаны дараа duplicate_matches-г TRUNCATE хийж offline дахин score-лоно — сайт руу дахин хандахгүй. Scrape дуусмагц: (1) scorer-ийн threshold/title-similarity-г 5,899+ зарын бодит corpus дээр дахин тохируулах (labeled багц өргөтгөх), (2) дараа нь re-score
 Week 6: Dashboard
